...
- `package.json`: local scripts for running, testing, and syntax validation
...
- `node scripts/local-validation.mjs`: run a scripted end-to-end validation flow and write proof artifacts
...
- `node scripts/local-validation.mjs` output plus the generated proof artifact paths
